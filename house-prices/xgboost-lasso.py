...
xgb_y_pred_train = xgb_regr.predict(train_df_munged)
print("XGBoost score on training set: ", rmse(label_df, xgb_y_pred_train))

# Run prediction on the Kaggle test set.
xgb_y_pred_test = xgb_regr.predict(test_df_munged)
...
# Run prediction on training set to get a rough idea of how well it does.
lasso_y_pred_train = lasso_regr.predict(train_df_munged)
print("Lasso score on training set: ", rmse(label_df, lasso_y_pred_train))

# Run prediction on the Kaggle test set.
lasso_y_pred_test = lasso_regr.predict(test_df_munged)

################################################################################

# Run prediction on training set for blended
xgb_lasso_pred_train = (xgb_y_pred_train + lasso_y_pred_train) / 2
print("Lasso score on training set: ", rmse(label_df, xgb_lasso_pred_train))

################################################################################

# Blend the results of the two regressors and save the prediction to a CSV file.

y_pred = (xgb_y_pred_test + lasso_y_pred_test) / 2
